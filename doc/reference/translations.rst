...
automatically loaded by TuniERP when the corresponding language is installed (via
...
TuniERP automatically exports translatable strings from "data"-type content:
...
code, TuniERP cannot automatically export translatable terms so they
