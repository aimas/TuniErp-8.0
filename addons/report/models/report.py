...
#--------------------------------------------------------------------------
# Check the presence of Wkhtmltopdf and return its version at TuniERP start-up
#--------------------------------------------------------------------------
...
try:
    ...
    if config['workers'] == 1:
        _logger.info('You need to start TuniERP with at least two workers to print a pdf version of the reports.')
