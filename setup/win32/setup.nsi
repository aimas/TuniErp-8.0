...
!define UNINSTALL_REGISTRY_KEY_SERVER "${UNINSTALL_BASE_REGISTRY_KEY}\TuniERP Server ${VERSION}"
...
InstallDir "$PROGRAMFILES\TuniERP ${VERSION}"
...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.tunierp.com/page/contactus"
...
; English
LangString DESC_OpenERP_Server ${LANG_ENGLISH} "Install the TuniERP Server with all the TuniERP standard modules."
LangString DESC_PostgreSQL ${LANG_ENGLISH} "Install the PostgreSQL RDBMS used by TuniERP."
LangString DESC_FinishPage_Link ${LANG_ENGLISH} "Contact TuniERP for Partnership and/or Support"
LangString DESC_AtLeastOneComponent ${LANG_ENGLISH} "You have to choose at least one component"
LangString DESC_CanNotInstallPostgreSQL ${LANG_ENGLISH} "You can not install the PostgreSQL database without the TuniERP Server"
...
LangString TITLE_OpenERP_Server ${LANG_ENGLISH} "TuniERP Server"
LangString TITLE_PostgreSQL ${LANG_ENGLISH} "PostgreSQL Database"
LangString DESC_FinishPageText ${LANG_ENGLISH} "Start TuniERP"

; French
LangString DESC_OpenERP_Server ${LANG_FRENCH} "Installation du Serveur TuniERP avec tous les modules TuniERP standards."
LangString DESC_PostgreSQL ${LANG_FRENCH} "Installation de la base de donn?es PostgreSQL utilis?e par TuniERP."
LangString DESC_FinishPage_Link ${LANG_FRENCH} "Contactez TuniERP pour un Partenariat et/ou du Support"
LangString DESC_AtLeastOneComponent ${LANG_FRENCH} "Vous devez choisir au moins un composant"
LangString DESC_CanNotInstallPostgreSQL ${LANG_FRENCH} "Vous ne pouvez pas installer la base de donn?es PostgreSQL sans le serveur TuniERP"
...
LangString TITLE_OpenERP_Server ${LANG_FRENCH} "Serveur TuniERP"
LangString TITLE_PostgreSQL ${LANG_FRENCH} "Installation du serveur de base de donn?es PostgreSQL"
LangString DESC_FinishPageText ${LANG_FRENCH} "Démarrer TuniERP"
...
# If there is a previous install of the OpenERP Server, keep the login/password from the config file
    ...
    nsExec::Exec "net stop tunierp-server-8.0"
    sleep 2

    nsExec::Exec "net start tunierp-server-8.0"
    sleep 2
...
Section $(TITLE_PostgreSQL) SectionPostgreSQL
    ...
    ExecWait '"$TEMP\${POSTGRESQL_EXE_FILENAME}" \
        ...
        --servicename "PostgreSQL_For_TuniERP" \
...
;    WriteRegDWORD HKLM     "${UNINSTALL_REGISTRY_KEY}" "VersionMinor" "${REVISION_VERSION}"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpLink" "support@tunierp.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "HelpTelephone" "+32.81.81.37.00"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.tunierp.com"
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "Contact" "sales@tunierp.com"
...
Section "Uninstall"
    ...
    nsExec::Exec "net stop tunierp-server-8.0"
    nsExec::Exec "sc delete tunierp-server-8.0"
    sleep 2
